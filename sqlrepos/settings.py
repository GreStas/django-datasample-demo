"""
Django settings for sqlrepos project.
...
SECRET_KEY = 'd3@!rwvbu52ca13e)$1lrn(#ibplh4qf^t(tlfy($*5qx9l=#7'
try:
...
WSGI_APPLICATION = 'sqlrepos.wsgi.application'
